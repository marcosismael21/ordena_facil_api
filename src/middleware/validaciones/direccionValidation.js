...
const ValidationRules = () => {
    return [
        body('clienteId').notEmpty().withMessage("El campo es obligatorio").isInt().withMessage("Debe ser un numero entero"),
        body('alias').notEmpty().withMessage("El campo es obligatorio").isString().isLength({
            max: 255
